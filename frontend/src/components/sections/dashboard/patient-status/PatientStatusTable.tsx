...
import { patientStatusData } from 'data/patientStatusData';
...
const PatientStatusTable = ({ searchText }: OrdersStatusTableProps) => {
  const apiRef = useGridApiRef<GridApi>();
  const [rows, setRows] = useState(patientStatusData);
